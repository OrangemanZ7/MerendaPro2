...
export default function SettingsPage() {
  ...
  const pages = [
    ...
    { id: "unit-types", label: "Unidades de Medida" },
  ...
  const handleUpdateRole = () => {
    ...
    setSettings((prev) => ({
      ...
      roles: prev.roles.map((r) =>
        r.id === editingRole.id ? { ...r, name: editingRole.name.trim() } : r,
      ),
    }));
    setEditingRole(null);
  };
  ...
  const handleDeleteRole = (roleId: string) => {
    ...
    if (
      confirm(
        "Tem certeza que deseja excluir esta função? As permissões associadas também serão removidas.",
      )
    ) {
      setSettings((prev) => {
      ...
      <header className="mb-8 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Gerencie a configuração e preferências do aplicativo.
          </p>
        </div>
      </header>
      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div className="md:col-span-1">
          <nav className="space-y-1">
            ...
            >
              <Settings
                className={`${activeTab === "general" ? "text-emerald-500" : "text-slate-400 group-hover:text-slate-500"} flex-shrink-0 -ml-1 mr-3 h-5 w-5`}
              />
            ...
            >
              <Shield
                className={`${activeTab === "security" ? "text-emerald-500" : "text-slate-400 group-hover:text-slate-500"} flex-shrink-0 -ml-1 mr-3 h-5 w-5`}
              />
              ...
              <div className="p-6 space-y-6">
                  ...
                  <>
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        Atualize a configuração básica do sistema.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="mt-1 text-xs text-slate-500">
                              PNG, JPG ou GIF até 2MB. Recomendado: fundo
                              transparente.
                            </p>
                          </div>
                          {settings.logoUrl && (
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-sm text-slate-500">
                          Alertas serão mostrados quando o estoque cair abaixo
                          deste número.
                        </p>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-slate-500">
                            Receba alertas de estoque baixo e novos pedidos.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {activeTab === "database" && (
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Configurações de banco de dados não estão disponíveis
                      nesta visualização.
                    </p>
                  </div>
                )}
                ...
                {activeTab === "security" && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        Gerencie o acesso às páginas e operações CRUD por
                        função.
                      </p>
                    </div>
