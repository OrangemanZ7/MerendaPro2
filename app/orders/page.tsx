...
export default function OrdersPage() {
  ...
  const [selectedOrderForReceive, setSelectedOrderForReceive] = useState<
    any | null
  >(null);
  ...
  const handlePrintOrder = (order: any) => {
    ...
    doc.text(
      `Fornecedor: ${order.type === "contract" ? order.contract?.supplier?.name || "Contrato" : order.supplierName || "Avulso"}`,
      titleX,
      titleY + 16,
    );
    doc.text(
      ...
      <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Gerencie pedidos de fornecedores para o Armazém Central.
          </p>
        </div>
        <Link
          href="/orders/new"
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-slate-500">
            ...
            <p className="mt-1">
              Crie seu primeiro pedido de compra para reabastecer o estoque.
            </p>
            <Link
              href="/orders/new"
